...
<div class="row justify-content-center vh-100 align-items-center">
  <div class="card col-5">
    <h1 class="text text-center">Verify your Login</h1><br><br>
    ...
    <form action="./../controller/validate_login_verify.php" method="POST">
      <div class="mb-3">
        <label for="verify-code">Verification Code:</label>
        <input type="number" class="form-control" name="verify-code">
      </div>
      <div class="mb-3">
